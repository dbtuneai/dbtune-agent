...
var (
	...
	PGIdleInTransactionAbortedConnections = MetricDef{Key: "pg_idle_in_transaction_aborted_connections", Type: Int}
	PGTotalConnections                    = MetricDef{Key: "pg_total_connections", Type: Int}
