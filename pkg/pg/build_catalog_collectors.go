...
func BuildCatalogCollectors(
	...
	entries := []entry{
		...
		{queries.PgIndexInventoryCollector(pool, prepareCtx, pgMajorVersion), simpleBase(queries.PgIndexInventoryName)},
		...
		{queries.PgStatProgressAnalyzeCollector(pool, prepareCtx, pgMajorVersion), simpleBase(queries.PgStatProgressAnalyzeName)},
		...
		{queries.PgStatSlruCollector(pool, prepareCtx, pgMajorVersion), simpleBase(queries.PgStatSlruName)},
