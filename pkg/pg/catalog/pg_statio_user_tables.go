...
type PgStatioUserTablesRow struct {
	...
	HeapBlksRead  *int64  `json:"heap_blks_read" db:"heap_blks_read"`       // pg: bigint
	HeapBlksHit   *int64  `json:"heap_blks_hit" db:"heap_blks_hit"`         // pg: bigint
	...
	ToastBlksRead *int64  `json:"toast_blks_read" db:"toast_blks_read"`     // pg: bigint
	ToastBlksHit  *int64  `json:"toast_blks_hit" db:"toast_blks_hit"`       // pg: bigint
	TidxBlksRead  *int64  `json:"tidx_blks_read" db:"tidx_blks_read"`       // pg: bigint
	TidxBlksHit   *int64  `json:"tidx_blks_hit" db:"tidx_blks_hit"`         // pg: bigint
}
