...
type PgStatUserTableRow struct {
	...
	SeqScan              *int64   `json:"seq_scan" db:"seq_scan"`                           // pg: bigint
	LastSeqScan          *string  `json:"last_seq_scan" db:"last_seq_scan"`                 // pg: timestamp with time zone
	SeqTupRead           *int64   `json:"seq_tup_read" db:"seq_tup_read"`                   // pg: bigint
	...
	NTupIns              *int64   `json:"n_tup_ins" db:"n_tup_ins"`                         // pg: bigint
	NTupUpd              *int64   `json:"n_tup_upd" db:"n_tup_upd"`                         // pg: bigint
	NTupDel              *int64   `json:"n_tup_del" db:"n_tup_del"`                         // pg: bigint
	NTupHotUpd           *int64   `json:"n_tup_hot_upd" db:"n_tup_hot_upd"`                 // pg: bigint
	NTupNewpageUpd       *int64   `json:"n_tup_newpage_upd" db:"n_tup_newpage_upd"`         // pg: bigint
	NLiveTup             *int64   `json:"n_live_tup" db:"n_live_tup"`                       // pg: bigint
	NDeadTup             *int64   `json:"n_dead_tup" db:"n_dead_tup"`                       // pg: bigint
	NModSinceAnalyze     *int64   `json:"n_mod_since_analyze" db:"n_mod_since_analyze"`     // pg: bigint
	NInsSinceVacuum      *int64   `json:"n_ins_since_vacuum" db:"n_ins_since_vacuum"`       // pg: bigint
	LastVacuum           *string  `json:"last_vacuum" db:"last_vacuum"`                     // pg: timestamp with time zone
	LastAutovacuum       *string  `json:"last_autovacuum" db:"last_autovacuum"`             // pg: timestamp with time zone
	LastAnalyze          *string  `json:"last_analyze" db:"last_analyze"`                   // pg: timestamp with time zone
	LastAutoanalyze      *string  `json:"last_autoanalyze" db:"last_autoanalyze"`           // pg: timestamp with time zone
	VacuumCount          *int64   `json:"vacuum_count" db:"vacuum_count"`                   // pg: bigint
	AutovacuumCount      *int64   `json:"autovacuum_count" db:"autovacuum_count"`           // pg: bigint
	AnalyzeCount         *int64   `json:"analyze_count" db:"analyze_count"`                 // pg: bigint
	AutoanalyzeCount     *int64   `json:"autoanalyze_count" db:"autoanalyze_count"`         // pg: bigint
	TotalVacuumTime      *float64 `json:"total_vacuum_time" db:"total_vacuum_time"`         // pg: double precision
	TotalAutovacuumTime  *float64 `json:"total_autovacuum_time" db:"total_autovacuum_time"` // pg: double precision
	TotalAnalyzeTime     *float64 `json:"total_analyze_time" db:"total_analyze_time"`       // pg: double precision
	TotalAutoanalyzeTime *float64 `json:"total_autoanalyze_time" db:"total_autoanalyze_time"` // pg: double precision
}
