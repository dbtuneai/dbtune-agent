...
// pg_class, pg_attribute, pg_attrdef, pg_constraint, and pg_indexes. This
// ensures a consistent catalog snapshot.
//
// HashDDL computes a SHA-256 fingerprint of the DDL for change detection,
// allowing the agent to skip re-sending schema when it hasn't changed.
//
// NOTE: intentionally limited to the 'public' schema — this is the standard
// schema for application tables and matches the scope expected by the backend's
// index advisor.
