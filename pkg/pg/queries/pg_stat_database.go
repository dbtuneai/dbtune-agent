...
type PgStatDatabaseRow struct {
	...
	ParallelWorkersToLaunch *Bigint          `json:"parallel_workers_to_launch" db:"parallel_workers_to_launch"`
	ParallelWorkersLaunched *Bigint          `json:"parallel_workers_launched" db:"parallel_workers_launched"`
}
