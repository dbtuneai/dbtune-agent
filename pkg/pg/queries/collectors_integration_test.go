...
func buildCollectors(pool *pgxpool.Pool, pgMajorVersion int) []CatalogCollector {
	return []CatalogCollector{
		...
		PgClassCollector(pool, noopPrepareCtx, DefaultPgClassConfig),
		...
		PgStatUserIndexesCollector(pool, noopPrepareCtx, DefaultPgStatUserIndexesConfig),
		PgStatUserTablesCollector(pool, noopPrepareCtx, DefaultPgStatUserTablesConfig),
		PgStatWalCollector(pool, noopPrepareCtx, pgMajorVersion),
		PgStatWalReceiverCollector(pool, noopPrepareCtx),
		PgStatioUserIndexesCollector(pool, noopPrepareCtx, DefaultPgStatioUserIndexesConfig),
